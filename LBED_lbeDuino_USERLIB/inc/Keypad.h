...
#if 0	// commented out by Takemoto 2013/11/30
	// Arduino versioning.
...
/**
 * Keypadをlbed用に移植しました
 * 以下の関数は、#define文でDegitalOutの操作に変更し、rowPins, colPinsはDegitalOutのインスタンス
 * に置き換えました。
 */
// lbed implements by Takemoto 2013/11/30
...
public:
	...
	Keypad(char *userKeymap, PinName *row, PinName *col, byte numRows, byte numCols);
/*
